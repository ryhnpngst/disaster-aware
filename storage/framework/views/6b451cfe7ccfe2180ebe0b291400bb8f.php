    ...
    <div class="container px-5">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          <li class="nav-item mx-5"><a class="nav-link active" aria-current="page" href="Home">Beranda</a></li>
          <li class="nav-item mx-5"><a class="nav-link" href="#Edukasi">Edukasi</a></li>
          <li class="nav-item mx-5"><a class="nav-link" href="#Galeri">Galeri</a></li>
          <li class="nav-item mx-5"><a class="nav-link" href="#Team">Tentang Kami</a></li>
        </ul>
      </div>
    </div>
  </nav>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active c-item" data-bs-interval="10000">
              ...
              <div class="carousel-caption top-0 mt-4">
                <p class="display-1 fw-bolder text-capitalize">let's raise awareness of the importance of the
                  environment
                </p>
    ...
    <div class="container px-5 my-5 px-5">
      <div class="row gx-5">
        <div class="col-lg-4 mb-5 mb-lg-0">
          <a class="btn btn-primary" href="#" role="button"><i class="fa-solid fa-book"></i></a>
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          <a class="btn btn-primary" href="#" role="button"><i class="fa-solid fa-magnifying-glass"></i></a>
          <h2 class="h4 fw-bolder">Featured title</h2>
          <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and
            probably just keep going until we run out of words.</p>
          <a class="text-decoration-none" href="#!">
        ...
        <div class="col-lg-4">
          <a class="btn btn-primary" href="#" role="button"><i class="fa-solid fa-clipboard-check"></i></a>
          <h2 class="h4 fw-bolder">Featured title</h2>
          <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and
            probably just keep going until we run out of words.</p>
          <a class="text-decoration-none" href="#!">
  ...
  <section class="py-5 border-bottom" id=""
    ...
    <div class="container px-5">
      <div class="row gx-5 align-items-center justify-content-center">
        ...
        <div class="col-lg-12">
          <div class="text-center my-5">
            <img src="./assets/disaster-awareness-low-resolution-logo-color-on-transparent-background 1.png" alt=""
              srcset="">
          </div>
        </div>
      </div>
...
</html><?php /**PATH C:\xampp\htdocs\disaster-aware\resources\views/user/landingPage/index.blade.php ENDPATH**/ ?>