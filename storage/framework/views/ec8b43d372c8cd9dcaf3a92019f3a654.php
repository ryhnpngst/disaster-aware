        ...
        <?php if($artikels): ?>
            <?php $__currentLoopData = $artikels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artikel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="col-lg-4">
                <!-- Blog post-->
                <div class="card mb-4">
                  <a href="#!"><img class="card-img-top" src="<?php echo e(asset('/storage/artikel/'.$artikel->image)); ?>"
                      alt="..." /></a>
                  <div class="card-body">
                    <div class="small text-muted"><?php echo e($artikel->created_at->format('d F Y')); ?></div>
                    <h2 class="card-title h4"><?php echo e($artikel->title); ?></h2>
                    <p class="card-text"><?php echo e($artikel->caption); ?></p>
                    <a class="btn btn-primary" href="<?php echo e(route('edukasi.show', $artikel->id)); ?>">Lanjut Baca</a>
                  </div>
                </div>
              </div>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active c-item" data-bs-interval="10000">
              ...
              <div class="carousel-caption top-0 mt-4">
                ...
                <a class="btn btn-primary px-4 py-2 fs-5 mt-5" href="<?php echo e(route('galeri')); ?>">Jelajahi Lebih Banyak Foto</a>
              </div>
            </div>
  ...
  <section class="py-5 border-bottom" id=""
    ...
    <div class="container px-5">
      <div class="row gx-5 align-items-center justify-content-center">
        ...
        <div class="col-lg-12">
          <div class="text-center my-5">
            <img src="<?php echo e(asset('assets/disaster-awareness-low-resolution-logo-color-on-transparent-background 1.png')); ?>" alt=""
              srcset="">
          </div>
        </div>
      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\disaster-aware\resources\views/user/index.blade.php ENDPATH**/ ?>