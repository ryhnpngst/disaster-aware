        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow mb-4">
                    <form action="<?php echo e(route('admin.artikel.store')); ?>" method="POST" enctype="multipart/form-data" class="p-3">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="author" name="author" value="<?php echo e(old('author')); ?>">
                          </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="caption" name="caption" value="<?php echo e(old('caption')); ?>">
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\disaster-aware\resources\views/admin/artikel/artikel-create.blade.php ENDPATH**/ ?>