...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('admin.admin.dashboard')); ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link<?php echo e(request()->routeIs('admin.admin.dashboard') ? ' active' : ''); ?>" href="<?php echo e(route('admin.admin.dashboard')); ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link<?php echo e(request()->routeIs('admin.akun.index') ? ' active' : ''); ?>" href="<?php echo e(route('admin.akun.index')); ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link<?php echo e(request()->routeIs('admin.laporan.index') ? ' active' : ''); ?>" href="<?php echo e(route('admin.laporan.index')); ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link<?php echo e(request()->routeIs('admin.artikel.index') ? ' active' : ''); ?>" href="<?php echo e(route('admin.artikel.index')); ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link<?php echo e(request()->routeIs('admin.galeri.index') ? ' active' : ''); ?>" href="<?php echo e(route('admin.galeri.index')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\disaster-aware\resources\views/admin/template.blade.php ENDPATH**/ ?>