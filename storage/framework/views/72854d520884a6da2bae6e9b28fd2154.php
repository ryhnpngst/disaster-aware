        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow mb-4">
                    <form action="<?php echo e(route('admin.laporan.store')); ?>" method="POST" enctype="multipart/form-data" class="p-3">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\disaster-aware\resources\views/admin/laporan/laporan-create.blade.php ENDPATH**/ ?>